...
def take_turn(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 3
    "*** YOUR CODE HERE ***"
    if num_rolls == 0: # Use the 'Boar Brawl' rule.
        return boar_brawl(player_score, opponent_score)
    else: # Use the 'Sow Sad' rule.
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    best_num_rolls, best_outcome = 1, 0.0
    for num_rolls in range(1, 11):
        averaged_roll_dice = make_averaged(roll_dice, samples_count)
        averaged_outcome = averaged_roll_dice(num_rolls, dice)
        if  averaged_outcome > best_outcome:
            best_num_rolls, best_outcome = num_rolls, averaged_outcome 
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    boar_brawl_sus_score = sus_update(0, score, opponent_score) - score
    return num_rolls if boar_brawl_sus_score < threshold else 0
    # END PROBLEM 11
